    ...
    <div className="animate-fade-in" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="text-center py-12 sm:py-16">
        <h1 className="text-3xl sm:text-4xl font-bold text-tfa-gray-800 mb-6 leading-tight">
          {survey?.title ?? (isRTL ? 'دراسة مشهد التدريب' : 'Training Landscape Study')}
        </h1>
        ...
        <Button
          size="lg"
          onClick={() => survey && navigate(`/survey/${survey.slug}/start`)}
          disabled={!survey}
          className="mt-4"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
        {[
          ...
          <div key={item.icon} className="bg-white border border-tfa-gray-200 rounded p-5 text-center shadow-card">
